...
Beacon is an experimental, personal iOS app developed as much as a learning exercise as to solve some of my workflow bottlenecks. It provides multiple avenues for interacting with my home server. The home server is a Raspberry Pi5 based system, exposed via cloudflare tunnel and various API gateways, and called the Array. It contains all my research (either PDFs or .md transcripts/summaries of research sources) and work related documents (as .md files), as well as various workflows, skills.md files, and detailed daily activity logs which are accessible to all the AI agents I work with on a daily basis on either my iPhone or MacBook. Tailscale provides connectivity via mobile data while away from my home wifi.

Built with SwiftUI, styled with a simple Mondrian-inspired design system. On-device support for voice transcription and chat with a local model included as part of my ongoing efforts to reduce the environmental impact of my AI use.
