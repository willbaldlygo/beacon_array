...
> **Note:** ALL code generated by Claude Opus 4.6, 4.7, and 4.8, Sonnet 4.6, and Haiku 4.5 via Claude Code. Also, this app is tightly coupled to a specific backend infrastructure. Many features won't run out of the box without a similar setup - but the purpose, on-device AI integration, and design principles may be of use to others building similar tools. Or just as a source of amusement for those who actually know how to write code!

Beacon is an experimental, personal iOS app developed as much as a learning exercise as to solve some of my workflow bottlenecks. It provides multiple avenues for interacting with my home server. The home server is a Raspberry Pi5 based system, exposed via cloudflare tunnel and various API gateways, and called the array. The array contains all my research (either PDFs or .md transcripts/summaries of research sources) and work related documents (as .md files), as well as various workflows, skills.md files, and detailed daily activity logs which are accessible to all the AI agents I work with on a daily basis on either my iPhone or MacBook. Beacon helps me interact with it whilst away from my MacBook. On-device support for voice transcription and chat with a local model included as part of my ongoing efforts to reduce the environmental impact of my AI use.
